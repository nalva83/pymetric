---
description: La puerta de entrada — te dice dónde está el proyecto y cuál es el único paso siguiente. Si el proyecto está virgen, te pide la idea y te lleva a /new-prd. Sin subagentes.
argument-hint: ""
---
...
1. **Mirá el estado:** ¿`docs/prd.md` sigue siendo la plantilla (placeholders `<...>`)?
   - **Sí (proyecto virgen):** saludá y pedile la idea en sus palabras — qué quiere construir y
     para quién. Con eso, ofrecé arrancar con `/new-prd <su idea>`.
